...
class DrawingCanvas(QWidget):
    def __init__(self, parent=None):
        ...
        self.canvas = QImage(800, 800, QImage.Format_RGB888) #ESTO GENERA UN CANVAS, NO LO ESCRIBAS DE VUELTA PEL-
    ...
    #Esto cambia el tamaño del pincel predeterminado
    def change_brush_size(self, value):
        self.brush_size = value

    #Esto cambia la opacidad del pincel predeterminado
